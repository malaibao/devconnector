...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (profile) {
        // If profile found, then we update
...
router.get('/', async (req, res) => {
  try {
    ...
    res.status(500).send('Server Error in Getting All Profiles');
  }
});
...
router.get('/user/:user_id', async (req, res) => {
  try {
    ...
    // If params.user_id is not a valid id
...
router.delete('/', auth, async (req, res) => {
  try {
    ...
    console.error(err.message);
    res.status(500).send('Server Error in Deleting User, Profile and Posts');
  }
});
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error(err.message);
      res.status(500).send('Server Error in Updating Experience');
    }
  }
);
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error(err.message);
      res.status(500).send('Server Error in Updating Education');
    }
  }
);
