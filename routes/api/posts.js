...
// @desc    Create a cooment on a post
// @access  Private
router.post(
  '/comment/:id',
  [
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error(err.message);
      res.status(500).send('Server Error in Creating Comment');
    }
  }
);

// @route   DELETE api/post/comment/:id/:comment_id
// @desc    Delete a cooment on a post
// @access  Private
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
  try {
    ...
    // objectId, so need to change to string
